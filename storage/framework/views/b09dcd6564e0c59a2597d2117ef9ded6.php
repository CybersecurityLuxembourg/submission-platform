    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form action="<?php echo e(route('forms.store')); ?>" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" value="<?php echo e(old('title')); ?>" class="w-full mt-2 p-2 border rounded" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" class="w-full mt-2 p-2 border rounded"><?php echo e(old('description')); ?></textarea>
