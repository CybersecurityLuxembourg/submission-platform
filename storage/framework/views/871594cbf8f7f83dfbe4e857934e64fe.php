...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(in_array($newField['type'], ['text', 'textarea'])): ?>
                        <div class="mt-6">
                            ...
                            <input type="number"
                                   ...
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['newField.char_limit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                    ...
                    <div class="flex items-center justify-between p-4">
                        ...
                        <div class="flex space-x-2">
                            <!--[if BLOCK]><![endif]--><?php if($index > 0): ?>
                                <button wire:click="moveCategoryUp(<?php echo e($category['id']); ?>)"
                                        class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-200">
                                    Move Up
                                </button>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if($index < count($categories) - 1): ?>
                                <button wire:click="moveCategoryDown(<?php echo e($category['id']); ?>)"
                                        class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-200">
                                    Move Down
                                </button>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <button wire:click="editCategory(<?php echo e($category['id']); ?>)"
                                    class="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-200">
                                Edit
                            </button>
                            <button wire:click="confirmDeleteCategory(<?php echo e($category['id']); ?>)"
                            ...
                            <div
                                ...
                                <div class="flex items-center">
                                    <!--[if BLOCK]><![endif]--><?php if($field['type'] == 'header'): ?>
                                        <span
                                            class="font-semibold text-gray-800 dark:text-gray-100 text-lg"><?php echo e($field['content']); ?></span>
                                    <?php elseif($field['type'] == 'description'): ?>
                                        <span class="text-gray-600 dark:text-gray-300"><?php echo e($field['content']); ?></span>
                                    <?php else: ?>
                                        <span
                                            class="font-medium text-gray-700 dark:text-gray-300"><?php echo e($field['label']); ?></span>
                                        <span
                                            class="text-gray-500 dark:text-gray-400 ml-2">(<?php echo e($field['type']); ?>)</span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                                <div class="flex space-x-2">
                                    <!--[if BLOCK]><![endif]--><?php if($fieldIndex > 0): ?>
                                        <button wire:click="moveFieldUp(<?php echo e($field['id']); ?>)"
                                                class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-200">
                                            Move Up
                                        </button>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($fieldIndex < count($category['fields']) - 1): ?>
                                        <button wire:click="moveFieldDown(<?php echo e($field['id']); ?>)"
                                                class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-200">
                                            Move Down
                                        </button>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <button wire:click="editField(<?php echo e($field['id']); ?>)"
                                            class="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-200">
                                        Edit
                                    </button>
                                    <button wire:click="confirmDeleteField(<?php echo e($field['id']); ?>)"
                                            class="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-200">
                                        Delete
                                    </button>
                                </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(in_array($fieldBeingEdited['type'], ['text', 'textarea'])): ?>
                                    <div class="mb-4">
                                        ...
                                        <input type="number"
                                               ...
                                               placeholder="No limit"
                                               class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['fieldBeingEdited.char_limit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(isset($field['char_limit']) && $field['char_limit'] && in_array($field['type'], ['text', 'textarea'])): ?>
                                    <span class="text-gray-500 dark:text-gray-400 ml-2">
                                    (max <?php echo e($field['char_limit']); ?> characters)
                                    </span>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
